...
3. Add the upstream remote:
   ```bash
   git remote add upstream https://github.com/whitehathub-007/langchaingo.git
   ```
...
- Open a [GitHub Discussion](https://github.com/whitehathub-007/langchaingo/discussions)
